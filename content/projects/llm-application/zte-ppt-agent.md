...
date: 2025-05-01
tags: ["大模型", "Agent", "PPT生成", "多Agent编排", "Qwen3"]
...
{{< figure src="/zte-ppt/系统架构.png" caption="PPT自动生成系统整体架构" >}}
...
{{< figure src="/zte-ppt/模板解析.png" caption="PPT模板解析与聚类流程" >}}
...
{{< figure src="/zte-ppt/Agent架构.png" caption="多Agent编排架构" >}}
